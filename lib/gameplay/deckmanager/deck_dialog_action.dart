...
class ActionDeckDialog extends ConsumerStatefulWidget {
  final List<CardData> deckPile;

  const ActionDeckDialog({
    super.key,
    required this.deckPile,
  });

  @override
  ConsumerState<ActionDeckDialog> createState() => _ActionDeckDialogState();
}

class _ActionDeckDialogState extends ConsumerState<ActionDeckDialog>
