...
class _FeatDisplayCardState extends State<FeatDisplayCard> {
  ...
  Widget build(BuildContext context) {
    // Debug the entire feat object
    final requirement = widget.feat['requirement'];
    print('\n=== FeatDisplayCard Build for ${widget.feat['name']} ===');
    print('Full feat keys: ${widget.feat.keys.toList()}');
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              color: _getTypeColor(widget.feat['type'] ?? 'Unknown'),
          ...
          Container(
            ...
            child: Text(
              widget.feat['requirement']?.toString() ?? '',
              style: const TextStyle(
                color: Colors.white,
                fontSize: 12,
              ),
